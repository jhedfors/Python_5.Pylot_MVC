...
routes['/products'] = 'Products#index_view'
routes['GET']['/products/show/<id>'] = 'Products#show_view'
routes['/products/new'] = 'Products#new_view'
routes['GET']['/products/edit/<id>'] = 'Products#edit_view'
